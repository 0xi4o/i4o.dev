...
A while ago, I wrote about how [I'm learning Rust](__GHOST_URL__/learning-rust-as-a-javascript-developer/). At the time, I got motivated to learn a new language and chose Rust, mainly because I wanted to get into systems programming. Another reason is that Rust is a fantastic option for web assembly.
