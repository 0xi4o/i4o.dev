...
date_published: 2022-06-20T09:10:18.000Z
date_updated: 2022-06-20T09:47:42.000Z
...
![](__GHOST_URL__/content/images/2022/06/1a.png)a typical git repository
...
![](__GHOST_URL__/content/images/2022/06/1.png)added a new worktree
...
![](__GHOST_URL__/content/images/2022/06/2.png)new feature-1 worktree has been created
If we `cd` into `feature-1` directory, we see this:
![](__GHOST_URL__/content/images/2022/06/3.png)new feature-1 worktree
...
![](__GHOST_URL__/content/images/2022/06/4.png)create a new worktree from an existing branch
Note that instead of saying "new branch '_<branch>_'", this time it says "checking out '_<branch>_'". Let's make some changes in the `hotfix` and `feature-1` worktrees.
![](__GHOST_URL__/content/images/2022/06/5.png)changes in worktrees stay independent of other worktrees
...
![](__GHOST_URL__/content/images/2022/06/6.png)list all worktrees
**To remove a worktree:**

    git worktree remove feature-2

![](__GHOST_URL__/content/images/2022/06/7.png)remove a worktree
...
![](__GHOST_URL__/content/images/2022/06/8.png)git worktrees alongside my repo root
...
![](__GHOST_URL__/content/images/2022/06/9.png)inside the .git hidden directory in your project root
...
![](__GHOST_URL__/content/images/2022/06/10.png)bare repo of one of my side projects
