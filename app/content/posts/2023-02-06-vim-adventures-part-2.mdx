...
Time flies. The last time I wrote about my [adventures with Vim](__GHOST_URL__/vim-adventures/), was a little over 6 months ago. In my last post, I wrote about why I started using Vim keybindings in my IDE of choice, WebStorm.
...
![](__GHOST_URL__/content/images/2023/02/relative_line_numbers.png)The current line is highlighted (line 54).
